    ...
    <div class="lg:w-1/2 xl:w-1/2 sm:w-full md:w-full">
        ...
        <div class="relative mb-3">
            <input type="text" id="Apellidos" name="Apellidos" required
                ...
                @endif>
            <label for="Apellidos"
                class="etiqueta">Apellidos</label>
        </div>
        ...
        <div class="relative mb-3">
            <input type="text" id="ocupacion" name="ocupacion" required
                class="caja"
                @if (isset($pacientes))
                    value="{{$pacientes->ocupacion}}"
                @endif>
            <label for="ocupacion"
                class="etiqueta">ocupacion</label>
        </div>
    ...
    <div class="lg:w-1/2 xl:w-1/2 sm:w-full md:w-full">
        ...
        <div class="relative mb-3">
            <input type="text" id="colonia" name="colonia" required
                class="caja"
                @if (isset($pacientes))
                    value="{{$pacientes->colonia}}"
                @endif>
            <label for="colonia"
                class="etiqueta">colonia</label>
        </div>
        ...
        <div class="relative mb-3">
            <input type="text" id="observaciones" name="observaciones" required
                class="caja"
                @if (isset($pacientes))
                    value="{{$pacientes->observaciones}}"
                @endif>
            <label for="observaciones"
                class="etiqueta">observaciones</label>
        </div>
