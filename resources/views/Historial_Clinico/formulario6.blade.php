...
<div class="container lg:flex xl:flex md:flex sm:block mt-3">
    ...
    <div class="lg:w-1/2 xl:w-1/2 sm:block sm:w-full">
        ...
        <div class="lg:w-full xl:w-full sm:w-full lg:flex mt-2">
            <!-- hijo-->
            <div class="relative mb-3 w-full">
                <input type="text" id="Refractivo" name="Refractivo" required class="caja">
                <label for="Refractivo" class="etiqueta">Refractivo O.D</label>
            </div>
            <div class="relative mb-3 w-full">
                <input type="text" id="RefractivoI" name="Refractivo" required class="caja">
                <label for="Refractivo" class="etiqueta">Refractivo O.I</label>
            </div>
        ...
        <div class="relative mb-3 w-full">
            <input type="text" id="Refractivo" name="Refractivo" required class="caja">
            <label for="Refractivo" class="etiqueta">Salud ocular</label>
        </div>

        <h2 class="subt">Plan de manejo</h2>
        <div class="relative mb-3 w-full">
            <input type="text" id="Refractivo" name="Refractivo" required class="caja">
            <label for="Refractivo" class="etiqueta">I</label>
        </div>
        <div class="relative mb-3 w-full">
            <input type="text" id="Refractivo" name="Refractivo" required class="caja">
            <label for="Refractivo" class="etiqueta">II</label>
        </div>
        <div class="relative mb-3 w-full">
            <input type="text" id="Refractivo" name="Refractivo" required class="caja">
            <label for="Refractivo" class="etiqueta">III</label>
        </div>

        <h2 class="subt">Observaciones</h2>
        <div class="relative mb-3 w-full">
            <label for="Observaciones" class="etiqueta">Observaciones</label>
            <textarea name="Observaciones" id="Observaciones" class="caja" cols="30" rows="5"></textarea>
        </div>
    </div>
</div>
