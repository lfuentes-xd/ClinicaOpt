        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('bienvenida.first')" :active="request()->routeIs('bienvenida.first')">
                        {{ __('Home') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('bienvenida.aboutUs')" :active="request()->routeIs('bienvenida.aboutUs')">
                        {{ __('Acerca de nosotros') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('historial.index')" :active="request()->routeIs('historial.index')">
                        {{ __('valores e historia') }}
                    </x-nav-link>
                </div>
